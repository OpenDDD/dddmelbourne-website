...
export default withPageMetadata((props: WithPageMetadataProps) => (
  <Page pageMetadata={props.pageMetadata} title="Sponsorship" description="Sponsorship opportunities for DDD Melbourne.">
    <h1>Sponsorship</h1>
    ...
    <ul>
      <li>
        ...
        request Professional Development (PD) budget from their employer to attend and it's accessible to most people
