...
const Meta: StatelessComponent<MetaArgs> = ({
  ...
  <Fragment>
    <Head>
      ...
      <meta property="og:image" content={pageImage || 'https://www.dddmelbourne.com/static/images/strip/2.jpg'} />
      <meta property="twitter:image" content={pageImage || 'https://www.dddmelbourne.com/static/images/strip/2.jpg'} />
