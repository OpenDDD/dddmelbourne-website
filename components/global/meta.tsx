...
const Meta: StatelessComponent<MetaArgs> = ({
  ...
  <Fragment>
    <Head>
      ...
      <meta property="og:image" content={pageImage || 'https://www.dddmelbourne.com/static/images/logo-2019.png'} />
      <meta property="twitter:image" content={pageImage || 'https://www.dddmelbourne.com/static/images/logo-2019.png'} />
